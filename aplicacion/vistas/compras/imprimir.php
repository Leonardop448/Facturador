        ...
        <div class="card-body">
            ...
            <?php if (!empty($compra) && !empty($detalles)): ?>
                <div class="mb-4">
                    ...
                    <?php if (isset($compra['cliente_nombre'])): ?>
                        <p><strong>Cliente:</strong> <?= htmlspecialchars($compra['cliente_nombre']) ?></p>
                    <?php endif; ?>
                    <p><strong>Usuario Responsable:</strong> <?= htmlspecialchars($compra['usuario_nombre']) ?></p>
                </div>
